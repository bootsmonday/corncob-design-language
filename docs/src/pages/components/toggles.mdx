...
<div class="corn-panel">
  <fieldset class="corn-form--item corn-toggle-group corn-toggle--xs" aria-labelledby="legend1-icon">
    <legend id="legend1-icon">Group Label</legend>
    <div class="corn-toggles">
      <div class="corn-toggle">
