...
**Example Reference**:
<CodeSample id="components-json-button">
```json
{
  "button": {
...
<CodeSample id="form-control-pattern">
```html
...
<CodeSample id="color-references">
...
<CodeSample id="sizing-references">
...
<CodeSample id="typography-references">
```json
...
<CodeSample id="component-class-validation">
```json
