...
- buttons: Added `type="button"` to all `<button>` elements and documentation examples.
- color: Added Teal, Purple, and Magenta colors to the color palette.

### Changed

- color: Changed the color palette to use a new set of colors generated by the BootsMonday Color Palette Tool.
