  ...
  <div class="corn-panel-menu">
    ...
    <corn-expandable class="corn-expandable">
      <details slot="details">
        <summary class="corn-panel-menu--item corn-expandable-button">Menu Category<svg class="corn-icon" aria-hidden="true"><use href={`${bootstrapIconsSprite}#chevron-right`}></use></svg></summary>
