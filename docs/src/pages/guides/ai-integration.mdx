...
<button class="corn-button corn-button--md" type="button"> //  Must include corn-button

// INVALID - undefined modifier
<button class="corn-button corn-button--extra-large" type="button"> // Only xs|sm|md|lg|xl
```
</div>
